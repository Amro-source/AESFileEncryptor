// AESFileEncryptor.cpp : Defines the entry point for the console application.
//
...
int _tmain(int argc, _TCHAR* argv[])
{
	...
	int FileSize = sizeof(ch);

	cout << "I am dumping the file now " << endl;
	...
	cout << "String Length  = "  << original_len << endl;
	...
	cout << "Padded Length =" << padded_len << endl;


	cout << "Total Message Length = " << original_len + padded_len << endl;
	...
	cout << "padded Message Length = " << sizeof(padded_msg)<<endl;
